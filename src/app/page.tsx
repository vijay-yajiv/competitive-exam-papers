      ...
      <section className="w-full max-w-6xl py-16 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center text-center p-4">
            ...
            <h3 className="text-xl font-semibold mb-2">Easy Viewing</h3>
            <p className="text-gray-600">View papers and solutions with a single click in PDF format for instant study.</p>
          </div>
