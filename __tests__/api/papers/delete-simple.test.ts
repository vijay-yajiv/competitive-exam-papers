...
describe('DELETE /api/papers/delete/[paperId] - Simple Test', () => {
  ...
  beforeEach(() => {
    ...
    mockGetPaperById = azureModule.getPaperById as jest.Mock;
  ...
  it('should successfully delete paper and return 200', async () => {
    ...
    expect(responseBody.message).toBe('Paper deleted successfully');
  ...
  it('should return 404 when paper not found', async () => {
    ...
    expect(responseBody.error).toBe('Paper not found');
  ...
  it('should handle deletion errors and return 500', async () => {
    ...
    expect(responseBody.error).toBe('Failed to delete paper');
